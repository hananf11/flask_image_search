...
@pytest.mark.parametrize(
    ...
    [
        ("vgg16", [2197, 4512, 2649, 4516, 2194]),
        ("vgg19", [4512, 4514, 2649, 4516, 2194]),
        ("inception_v3", [4512, 4514, 2649, 4516, 5171]),
    ],
    ...
    [
        (
            "vgg16",
            {
                ...
                371: [4516, 4514, 4515, 1798, 4517, 4519, 4518, 1800, 1799],
            }
        ),
        (
            "vgg19",
            {
                ...
                371: [4514, 4516, 4515, 4517, 1798, 4519, 4518, 1800, 1799],
        ...
        (
            "inception_v3",
            {
                ...
                371: [4514, 4516, 4519, 4515, 1798, 1800, 4518, 4517, 1799],
                1011: [5171, 5172, 5170, 5173, 5178, 5180, 5179, 5177, 5175, 5176, 5181, 5174]
            }
        ),
    ],
    ids=["vgg16", "vgg19", "inception_v3"],
